...
const Sidebar = () => {
  ...
  return (
    <div>
      {sidebarOpen ? (
        <div className="bg-gray-800 text-white h-screen w-32 fixed left-0 top-0 flex flex-col justify-between md:w-32">
          <div className="mt-8">
        ...
        <div className="bg-gray-800 text-white h-screen w-16 fixed left-0 top-0 flex flex-col justify-between md:w-16">
          <div className="mb-8">
            <button
              className="flex items-center p-4 text-center"
              onClick={toggleSidebar}
